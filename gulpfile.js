...
gulp.task('build', function(callback) {
    Plugins.sequence(['clean-css', 'clean-images', 'clean-js', 'clean-html'], ['concatcss-general'], ['taskCss', 'taskImages', 'taskJs'], 'taskHtml','concatscss-quality', callback);
});
...
gulp.task('default', ['browser-sync'], function() {
    ...
    gulp.watch($CFG.watch.html, ['taskHtml']);
	 gulp.watch($CFG.watch.sass_src, ['concatscss-quality']);
});